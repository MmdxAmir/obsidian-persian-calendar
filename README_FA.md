...
| `Q`            | 1           | شمارهٔ فصل میلادی             |
| `QQ`           | 01          | شمارهٔ فصل میلادی دورقمی      |
| `QQQ`          | Spr         | نام کوتاه فصل میلادی          |
| `QQQQ`         | Spring      | نام کامل فصل میلادی           |

</div>

توکن‌های `Q` تا `QQQQ` فصل میلادی را بر اساس سه‌ماهه‌های تقویمی مشخص می‌کنند: `Q1`، `Q2`، `Q3` و `Q4` به‌ترتیب با بهار، تابستان، پاییز و زمستان متناظر هستند.

در مسیرهای هفته‌نوشت، اگر مسیر شامل هم یک توکن هفته و هم حداقل یک توکن وابسته به تاریخ باشد، می‌توانید مشخص کنید توکن‌های تاریخی بر اساس **ابتدای هفته** یا **انتهای هفته** محاسبه شوند. این گزینه با نام «مبنای تاریخ مسیر هفته‌نوشت» در تنظیمات هفته‌نوشت قرار دارد.

برای مثال، در مسیری مانند `jYYYY/jMM/ww` ممکن است ابتدای هفته در یک ماه یا سال و انتهای همان هفته در ماه یا سال دیگری قرار داشته باشد. انتخاب مبنا تعیین می‌کند `jYYYY` و `jMM` از کدام سمت هفته محاسبه شوند.

همین رفتار برای توکن‌های فصل میلادی نیز برقرار است. برای نمونه، اگر یک هفته بین دو فصل میلادی قرار گرفته باشد، مقدار `Q`، `QQ`، `QQQ` یا `QQQQ` بسته به انتخاب ابتدای هفته یا انتهای هفته تعیین می‌شود.

این مبنا فقط زمانی کاربرد دارد که مسیر هفته‌نوشت هم توکن هفته و هم توکن وابسته به تاریخ داشته باشد. مسیری مانند `ww` که فقط شامل توکن هفته است، به این گزینه نیازی ندارد.
