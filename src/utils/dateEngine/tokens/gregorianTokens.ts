...
export const gregorianTokens: TTokenDefinition[] = [
	...
	createNumericToken({
		token: "YY", family: "gregorian", field: "gy", digits: 2, pad: true,
		encode: (y) => ((y % 100) + 100) % 100,
	}),
	createNameToken({ token: "MMMM", family: "gregorian", field: "gm", namesByLocale: GREGORIAN_MONTHS_NAME }),
	createNameToken({ token: "MMM", family: "gregorian", field: "gm", namesByLocale: GREGORIAN_MONTHS_NAME, abbreviate: true }),
	...
	createNameToken({ token: "QQQ", family: "gregorian", field: "quarter", namesByLocale: GREGORIAN_SEASONS_SHORT_NAME }),
	createNameToken({ token: "QQQQ", family: "gregorian", field: "quarter", namesByLocale: GREGORIAN_SEASONS_NAME }),
	createNameToken({ token: "DDDD", family: "gregorian", field: "dow", namesByLocale: WEEKDAYS_NAME }),
];
